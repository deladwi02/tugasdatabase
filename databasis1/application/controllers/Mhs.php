...
class Mhs extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('mhs/tb_agus_list', $data);
    ...
    public function read($id) 
    {
		...
		'prodi' => $row->prodi,
            ...
            $this->load->view('template/header');
        $this->load->view('template/navbar');
            $this->load->view('mhs/tb_agus_read', $data);
            $this->load->view('template/footer');
        } else {
    ...
    public function create() 
    {
	    ...
	    'prodi' => set_value('prodi'),
         ...
         $this->load->view('template/header');
        $this->load->view('template/navbar');
        $this->load->view('mhs/tb_agus_form', $data);
        $this->load->view('template/footer');
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-06-22 07:02:31 */
/* http://harviacode.com */