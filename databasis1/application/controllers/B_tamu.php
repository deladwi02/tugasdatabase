...
class B_tamu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['total_rows'] = $this->M_b_tamu->total_rows($q);
        $b_tamu = $this->M_b_tamu->get_limit_data($config['per_page'], $start, $q);
    ...
    {
        $row = $this->M_b_tamu->get_by_id($id);
        if ($row) {
            $data = array(
		'id' => $row->id,
		'nama' => $row->nama,
    ...
    public function update_action() 
    {
		...
		'tgl_pesan' => $this->input->post('tgl_pesan',TRUE),
            ...
            $this->M_b_tamu->update($this->input->post('id', TRUE), $data);
	...
	foreach ($this->M_b_tamu->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'tb_buku_tamu_data' => $this->M_b_tamu->get_all(),
            'start' => 0
        );
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-06-29 18:23:44 */
/* http://harviacode.com */