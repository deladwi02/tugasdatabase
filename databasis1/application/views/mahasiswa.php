...
<table class="table">
    ...
    <td>
        <a href="<?php echo base_url().'index.php/mahasiswa/edit/' ?>                                                       "><button class="btn-md btn-primary">Edit</button></a>
        <a href="<?php echo base_url().'index.php/mahasiswa/delete/'?><?php echo $mhs->id ?>"><button class="btn-md btn-danger">Hapus</button></a>
