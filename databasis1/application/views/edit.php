    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <input type="hidden" name="id" value="<?php echo $mhs->id ?>" class="form-control">
            <input type="text" name="npm" value="<?php echo $mhs->npm ?>" class="form-control" placeholder="NIM">
          </div>
        </div>
        <div class="form-group row">
...
<div class="form-group row">
  ...
  <select class="form-control" id="exampleFormControlSelect1" name="prodi">
      <option><?php echo $mhs->prodi ?></option>
